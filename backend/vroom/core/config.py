...
class Settings(BaseSettings):
    ...
    stripe_connect_business_name: str = Field(
        default="Vroom", validation_alias="STRIPE_CONNECT_BUSINESS_NAME"
    )
    stripe_connect_business_url: str = Field(
        default="", validation_alias="STRIPE_CONNECT_BUSINESS_URL"
    )
    stripe_connect_support_email: str = Field(
        default="", validation_alias="STRIPE_CONNECT_SUPPORT_EMAIL"
    )
    stripe_connect_api_version: str = Field(
        default="2026-05-27.preview",
        validation_alias="STRIPE_CONNECT_API_VERSION",
    )
    ...
    @field_validator(
        ...
        "stripe_connect_business_name",
        "stripe_connect_business_url",
        "stripe_connect_support_email",
