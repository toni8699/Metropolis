...
from vroom.core.limiter import limiter, rate_limit_user_or_ip
from vroom.dependencies.auth import UserContext, get_current_user, verified_user_required
from vroom.hateoas import with_booking_links
from vroom.schemas.booking_models import (
...
from vroom.sockets.booking_chat import emit_booking_message
...
def list_bookings(
    ...
    if scope == "mine":
        result = booking_service.list_renter_bookings(user.user_id, page=page, page_size=page_size)
    elif scope == "owner":
